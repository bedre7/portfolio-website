      ...
      <header>
        ...
        <div class = "container-fluid padding">
            <div class = "row welcome">
                <h1>Hi there! <br> Welcome to my webpage :)</h1>  
                <a  href ="Login files/login.php" class = "btn btn-primary btn-lg" href="#">Log In</a>
                <a  class = "btn btn-secondary btn-lg" href="#">Contact</a>
            </div>
        </div>
      </header>
        <section class = "about-me">
            <div class = "container-fluid padding">
                ...
                <div class = "row padding">
                    ...
                    <div class="col-md-12 col-lg-6 essay vl">           
                        ...
                        <p>Ping pong&#127955, football and last but not least archery&#127993 are my favorite activities.</p>
                        <br>
                    </div>
    ...
    <footer>
        <div class = "container-fluid">
            <div class = "text-center">
                <div class = "col-sm-6">
                    <span class = "col-sm-12"><h1 class = "brand-title">Ethiopix</h1> </span>
                    <h2>Address</h2>
                    <i class="fas fa-map-marker-alt"></i>
                    <span>Sakarya, Turkey</span><br>
                    <i class="fas fa-mobile-alt"></i>
                    <span>+90-553-950-8888</span><br>
                    <i class="fas fa-envelope"></i>
                    <span>bedru777@gmail.com</span>
                </div>
        ...
        <div class = "col-9 copyright">
            <hr class = "light">
            <h5>&copy; 2021 Designed by Bedru. All rights reserved.</h5>
        </div>
    </footer>
